...
public:
  ...
  protected:
    VAO _vao;
    /* vector of the positions of the left hand corners */
    ...
    std::vector<glm::vec4> coordinateToHomogene(std::vector<glm::vec2> normalCoordinates);
    std::vector<glm::vec2> homogeneToCoordinate(std::vector<glm::vec4> homogeneCoordinates);
