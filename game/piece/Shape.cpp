...
std::vector<glm::vec2> Shape::getSquareOriginsPositions()
{
  return _squareOriginsPositions;
}
std::vector<glm::vec2> Shape::getSquarePositions()
{
  return _squarePositions;
}
void Shape::setSquarePositions(const std::vector<glm::vec2> & squarePositions)
{
  _squarePositions = squarePositions;
}
std::vector<glm::vec4> Shape::coordinateToHomogene(std::vector<glm::vec2> normalCoordinates)
{
...
std::vector<glm::vec2> Shape::homogeneToCoordinate(std::vector<glm::vec4> homogeneCoordinates)
{
